...
import ComboChartToast from '../AllCharts/toastui/ComboChartToast';

const ToastUIChart = (props) => {
  const chartWidth =
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col sm={6} md={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">Column charts kkk</CardTitle>
            ...
            <Col sm={6} md={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">Combo Chart</CardTitle>
                  <div className="text-center">
                    <ComboChartToast chartWidth={chartWidth} />
                  </div>
                </CardBody>
              </Card>
            </Col>
